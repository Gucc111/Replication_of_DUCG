...
# 添加有向弧
e1 = DUCGEdge("B1","X3")
e2 = DUCGEdge("B1","X4", weight=1, prob_matrix=np.random.rand(3, 2))
e3 = DUCGEdge("B2","X4", weight=3, prob_matrix=np.random.rand(3, 2))
e4 = DUCGEdge("B2","X5", condition={'X3': 1})  # 带条件
e5 = DUCGEdge("X3","G8")
e6 = DUCGEdge("X4","X6", weight=4, prob_matrix=np.random.rand(3, 3))
e7 = DUCGEdge("X5","G8")
e8 = DUCGEdge("G8","X7")
e9 = DUCGEdge("D9","X7")
e10 = DUCGEdge("X7","X6")
